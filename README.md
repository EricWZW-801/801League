...
<body>
    ...
    <div class="input-card">
        ...
        <div class="btn-group">
            <button class="btn-submit" onclick="submitMatch()">记录 & 生成战报</button>
    ...
    <div class="section-title">
        ...
        <button class="action-btn btn-danger" onclick="clearAllData()">🗑️ 清空所有</button>
    </div>
    ...
    <div class="section-title">
        ...
        <button class="action-btn btn-warn" id="undo-btn" onclick="undoLastMatch()" style="display:none;">↩️ 撤销上一局</button>
    </div>
    ...
    <div style="font-size:0.75rem; color:#555; text-align:center; margin-top:8px; font-family:var(--font-body);">点击记录可查看详情</div>
    ...
    <div class="modal-overlay" id="share-modal">
        ...
        <div class="modal-btns" id="modal-controls">
            <button class="btn-download" onclick="downloadPoster()">📸 保存为图片</button>
